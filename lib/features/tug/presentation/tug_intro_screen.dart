...
class TugIntroScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => AssessmentIntroLayout(
    ...
    instructions: const <String>[
      'ระบบจะตรวจเซนเซอร์และบอกตำแหน่งคาดโทรศัพท์ที่เหมาะกับเครื่องนี้',
      'จัดเก้าอี้มั่นคงและทำเครื่องหมายระยะเดิน 3 เมตร',
      'กดปรับเทียบหนึ่งครั้ง จากนั้นระบบจะพูดคำสั่งและเริ่มให้อัตโนมัติ',
      'เมื่อได้ยินคำว่า “เริ่ม” ให้ลุก เดิน หมุนตัว เดินกลับ และนั่งลงตามปกติ',
    ],
    notice:
        'ถ้าเครื่องไม่มี Gyroscope ระบบจะใช้โหมด Accelerometer-only '
        'และบันทึกเฉพาะเวลารวม ควรมีผู้ดูแลอยู่ใกล้ตลอด '
        'หากไม่ปลอดภัยให้กด “หยุดการทดสอบ” ได้ทันที',
